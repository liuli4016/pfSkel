...
bool GetAllDivPoints(
	...
	DynamicArray<DivergencePoint> &HDPts,  // [out] high divergence point list
	bool inOut                    // [in] flag specifying if we should look
	                              //    outside the object too (if true).
	                              // DEFAULT: false
) {

  printf("GetAllDivPoints - NOT IMPLEMENTED !!\n");
  
  /*
#ifdef TRACE
  printf("TRACE: Starting GetAllDivPoints function. Cellsize = %lf\n", CELL_SIZE);
#endif
