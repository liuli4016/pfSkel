...
bool GetLocalMinDivPoints(
  ...
  printf("GetLocalMinDivPoints -- NOT IMPLEMENTED \n");
  return true;
	...
	for(kk=0; kk < SEARCH_GRID; kk++) {
	  for(jj=0; jj < SEARCH_GRID; jj++) {
	    for(ii=0; ii < SEARCH_GRID; ii++) {
	      ...
	      div = GetDiv(x, y, z, L, M, N, ForceField, flags);
	      //
	      // neighbors
	      //
	      ns[0] = GetDiv(x-CELL_SIZE, y, z, L, M, N, ForceField, flags);
	      ...
	      ns[3] = GetDiv(x-CELL_SIZE, y, z-CELL_SIZE, L, M, N, ForceField, 
			     flags);
	      ns[4] = GetDiv(x-CELL_SIZE, y-CELL_SIZE, z-CELL_SIZE, L, M, N, 
			     ForceField, flags);
	      ns[5] = GetDiv(x-CELL_SIZE, y+CELL_SIZE, z-CELL_SIZE, L, M, N, 
			     ForceField, flags);
	      ns[6] = GetDiv(x-CELL_SIZE, y, z+CELL_SIZE, L, M, N, ForceField, 
			     flags);
	      ns[7] = GetDiv(x-CELL_SIZE, y-CELL_SIZE, z+CELL_SIZE, L, M, N, 
			     ForceField, flags);
	      ns[8] = GetDiv(x-CELL_SIZE, y+CELL_SIZE, z+CELL_SIZE, L, M, N, 
			     ForceField, flags);

	      ns[9] = GetDiv(x, y-CELL_SIZE, z, L, M, N, ForceField, flags);
	      ns[10] = GetDiv(x, y+CELL_SIZE, z, L, M, N, ForceField, flags);
	      ns[11] = GetDiv(x, y, z-CELL_SIZE, L, M, N, ForceField, flags);
	      ns[12] = GetDiv(x, y-CELL_SIZE, z-CELL_SIZE, L, M, N, ForceField,
			      flags);
	      ns[13] = GetDiv(x, y+CELL_SIZE, z-CELL_SIZE, L, M, N, ForceField,
			      flags);
	      ns[14] = GetDiv(x, y, z+CELL_SIZE, L, M, N, ForceField, flags);
	      ns[15] = GetDiv(x, y-CELL_SIZE, z+CELL_SIZE, L, M, N, ForceField,
			      flags);
	      ns[16] = GetDiv(x, y+CELL_SIZE, z+CELL_SIZE, L, M, N, ForceField,
			      flags);

	      ns[17] = GetDiv(x+CELL_SIZE, y, z, L, M, N, ForceField, flags);
	      ...
	      ns[20] = GetDiv(x+CELL_SIZE, y, z-CELL_SIZE, L, M, N, ForceField,
			      flags);
	      ns[21] = GetDiv(x+CELL_SIZE, y-CELL_SIZE, z-CELL_SIZE, L, M, N, 
			      ForceField, flags);
	      ns[22] = GetDiv(x+CELL_SIZE, y+CELL_SIZE, z-CELL_SIZE, L, M, N, 
			      ForceField, flags);
	      ns[23] = GetDiv(x+CELL_SIZE, y, z+CELL_SIZE, L, M, N, ForceField,
			      flags);
	      ns[24] = GetDiv(x+CELL_SIZE, y-CELL_SIZE, z+CELL_SIZE, L, M, N, 
			      ForceField, flags);
	      ns[25] = GetDiv(x+CELL_SIZE, y+CELL_SIZE, z+CELL_SIZE, L, M, N, 
			      ForceField, flags);
